...
[^charge-diff]: Here, $\xi^{\ast}$ is the _proposed_ configuration (prior to
Accept / Reject)
[^jacobian]: $\left|\frac{\partial \xi^{\ast}}{\partial \xi^{T}}\right|$ is the
