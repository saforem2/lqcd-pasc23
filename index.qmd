...
- Want to (sequentially) construct a chain of states $x_{0} \rightarrow x_{1} \rightarrow \cdots \rightarrow x_{N}$  
  such that, as $N \rightarrow \infty$: $$\left\{x_{i}, x_{i+1}, x_{i+2}, \cdots, x_{N} \right\}
  \longrightarrow p(x) \propto e^{-S(x)}$$
...
::: {.column width="50%" style="text-align: left!important;"}
...
# {.centeredslide background-iframe="https://github.com/saforem2/l2hmc-qcd/blob/e5e0deeea35e56e37c19018d0fd950a85395fb24/src/l2hmc/notebooks/l2hmc-2dU1.ipynb" loading="lazy"}
...
- References:
    - [Link to slides](https://saforem2.github.io/lqcd-pasc23/)
        - [link to github with slides](https://github.com/saforem2/lqcd-pasc23)
