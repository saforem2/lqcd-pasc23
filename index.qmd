...
- Want to maximize the _expected_ squared charge difference[^charge-diff]:
  $$\begin{equation*}
  \mathcal{L}_{\theta}\left(\xi^{\ast}, \xi\right) = {\mathbb{E}_{p(\xi)}}\big[-\textcolor{#FA5252}{{\delta Q}}^{2} \left(\xi^{\ast}, \xi \right)\cdot A(\xi'|\xi)\big]
  \end{equation*}$$

- Where $\delta Q$ is the _tunneling rate_:
  $$\begin{equation*}
  \textcolor{#FA5252}{\delta Q}(\xi',\xi)=\left|Q' - Q\right|
  \end{equation*}$$
