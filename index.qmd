...
$v_{1} := \textcolor{#e8590c}{\Gamma}(x_{0}; v_{0}) = v_{0} - \frac{\varepsilon}{2} \partial_{x} S(x_{0})\hspace{3px}$

<!-- 2. [update $\textcolor{#D0BFFF}{x}$]{style="font-family:monospace"} -->
$x' := \textcolor{#0c8599}{\Lambda}(x_{0}; v_{1}) = x_{0} + \varepsilon \, v_{1}\hspace{29px}$

<!-- 3. [update $\textcolor{#B2F2BB}{v}$]{style="font-family:monospace"} -->
$v' := \textcolor{#e8590c}{\Gamma}(x'; v_{1}) = v_{1} - \frac{\varepsilon}{2} \partial_{x} S(x')\hspace{8px}$ 
...
$$\begin{align*}
  \textcolor{#e8590c}{\Gamma}: (x, v) \textcolor{#e8590c}{\rightarrow} v' &:= v - \frac{\varepsilon}{2} \partial_{x} S(x) \\
  \textcolor{#0c8599}{\Lambda}: (x, v) \textcolor{#0c8599}{\rightarrow} x' &:= x + \varepsilon v
\end{align*}$$
